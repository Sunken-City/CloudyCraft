...
bool Block::IsPortal(Direction portalFace)
{
    ...
    //An extra case. Checks to see if ANY of the faces has a portal
    //This will have a problem as soon as we start using those upper bits for anything else
    case Direction::NUM_DIRECTIONS:
        return (m_portalFlags & PORTAL_ALL_BITS) != 0;
    default:
        return false;
    }
}
